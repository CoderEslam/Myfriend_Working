...
import com.spacester.myfriend.reel.ReelCommentActivity;
...
import com.spacester.myfriend.who.ReelLikedActivity;
                        ...
                        if (snapshot.exists()) {
                            ...
                            FirebaseDatabase.getInstance().getReference("Users").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    ...
                                    if (notify){
                                        sendNotification(modelReel.getId(), Objects.requireNonNull(user).getName(), "liked on your reel");
                                    }
                                    notify = false;
                                }

...
import com.spacester.myfriend.podcast.PodcastActivity;
...
public class AdapterPodcast extends RecyclerView.Adapter<AdapterPodcast.MyHolder>{
    ...
    int channelProfile;
    public static final String channelMessage = "com.spacester.myfriend.CHANNEL";
    public static final String profileMessage = "com.spacester.myfriend.PROFILE";
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(channelMessage, room);

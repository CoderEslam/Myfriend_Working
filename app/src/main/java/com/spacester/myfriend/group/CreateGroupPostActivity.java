...
import com.spacester.myfriend.post.FeelingActivity;
import com.spacester.myfriend.post.PrivacyPick;
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()){
                            ...
                            reference.child(room).setValue(hashMap).addOnCompleteListener(task -> {
                                Intent i = new Intent(CreateGroupPostActivity.this, StartLiveActivity.class);

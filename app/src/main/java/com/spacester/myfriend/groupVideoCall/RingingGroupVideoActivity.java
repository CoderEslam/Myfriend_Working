package com.spacester.myfriend.groupVideoCall;
...
import com.spacester.myfriend.groupVideoCall.openvcall.ui.VideoGroupCallActivity;
import com.spacester.myfriend.groupVoiceCall.openacall.ui.BaseActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseDatabase.getInstance().getReference("Groups").child(groupId).child("Video").child(room).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (Objects.requireNonNull(snapshot.child("type").getValue()).toString().equals("cancel")){
                    mp.stop();
        ...
        findViewById(R.id.pick).setOnClickListener(v -> {
            ...
            i.putExtra(com.spacester.myfriend.groupVideoCall.openvcall.model.ConstantApp.ACTION_KEY_CHANNEL_NAME, room);
            i.putExtra(com.spacester.myfriend.groupVideoCall.openvcall.model.ConstantApp.ACTION_KEY_ENCRYPTION_KEY, encryption);
